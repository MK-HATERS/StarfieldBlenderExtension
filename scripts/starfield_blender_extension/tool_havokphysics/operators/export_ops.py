...
import os
import subprocess
from ..export_util.starfield_export import starfield_fbx_export
from ..export_util.batfile_factory import generate_filtermanager_batfile
from ..export_util.post_process_hkx import post_process_hkx


class ExportVertexGroupWeightsOperator(bpy.types.Operator):
    bl_idname = "bgs_starfield.havok_export_vertex_group_weights"
...
class SaveHKXSelectionSetOperator(bpy.types.Operator):
    bl_idname = "bgs_starfield.havok_extract_uv_indices"
...
class ExportFBXAndRunImporterOperator(bpy.types.Operator):
    bl_idname = "bgs_starfield.havok_export_and_run_fbximporter"
...
class PostProcessHKXOperator(bpy.types.Operator):
    bl_idname = "bgs_starfield.havok_cloth_postprocess"
