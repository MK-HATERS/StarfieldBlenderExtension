...
node_categories = [
    ...
    MyNodeCategory('SELECTION', "Select", items=[
        ...
        NodeItem("CombineBoneSelection", label="Combine Bone Selection"),
    ]),
    MyNodeCategory('SIMDATA', "Simulation", items=[
        ...
        NodeItem("SetParticleAttr", label="Set Particle Attributes"),
    ]),
...
classes = [
    ...
    Simulation.SetParticleAttrNode,
    ...
    Skeleton.CombineBoneSelectionNode,
